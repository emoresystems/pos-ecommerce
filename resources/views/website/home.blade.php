        ...
        <div class="max-w-7xl mx-auto px-4 py-16 flex flex-col md:flex-row items-center">
            <div class="md:w-1/2 text-center md:text-left">
                ...
                <div class="mt-8 flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                    <a href="{{ url('/perfumes') }}" class="px-8 py-3 bg-amber-600 text-white rounded-full shadow-lg hover:bg-amber-700 transition duration-300 flex items-center justify-center">
                        Shop Now <i class="fas fa-arrow-right ml-2"></i>
                    </a>
                    <a href="#" class="px-8 py-3 border border-amber-600 text-amber-600 rounded-full hover:bg-amber-50 transition duration-300 flex items-center justify-center">
                        Learn More
                    </a>
                </div>
            </div>
            <div class="md:w-1/2 mt-12 md:mt-0 flex justify-center">
                <div class="relative">
                    ...
                    <div class="absolute -inset-4 bg-amber-200 rounded-xl -z-10 transform -rotate-2"></div>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="relative group overflow-hidden rounded-2xl shadow-lg">
                    ...
                    <div class="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center flex-col opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        ...
                        <a href="#" class="mt-4 text-amber-300 hover:text-white">Explore <i class="fas fa-arrow-right ml-1"></i></a>
                    </div>
                </div>
                <div class="relative group overflow-hidden rounded-2xl shadow-lg">
    ...
    <section class="py-16 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex justify-between items-center mb-12">
                ...
                <a href="{{ url('/perfumes') }}" class="text-amber-600 hover:text-amber-800 flex items-center">
            ...
            <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                <div class="bg-white perfume-card rounded-xl shadow-md overflow-hidden">
                    <div class="relative">
                        ...
                        <span class="absolute top-4 left-4 bg-amber-600 text-white text-xs px-2 py-1 rounded">NEW</span>
                    </div>
                    <div class="p-4">
                        <div class="flex justify-between items-start">
                            ...
                            <span class="text-amber-600 font-bold">$89.00</span>
                        </div>
                        ...
                        <button class="mt-4 w-full px-4 py-2 bg-amber-600 text-white rounded-lg hover:bg-amber-700 transition duration-300 flex items-center justify-center">
                ...
                <div class="bg-white perfume-card rounded-xl shadow-md overflow-hidden">
                    ...
                    <div class="p-4">
                        <div class="flex justify-between items-start">
                            ...
                            <span class="text-amber-600 font-bold">$78.00</span>
                        </div>
                        <div class="mt-4 flex items-center">
                            <div class="flex text-yellow-400">
                                <i class="fas fa-star"></i>
                ...
                <div class="bg-white perfume-card rounded-xl shadow-md overflow-hidden">
                    ...
                    <div class="p-4">
                        <div class="flex justify-between items-start">
                            ...
                            <span class="text-amber-600 font-bold">$125.00</span>
                        </div>
                        <div class="mt-4 flex items-center">
                            <div class="flex text-yellow-400">
                                <i class="fas fa-star"></i>
                ...
                <div class="bg-white perfume-card rounded-xl shadow-md overflow-hidden">
                    ...
                    <div class="p-4">
                        <div class="flex justify-between items-start">
                            ...
                            <span class="text-amber-600 font-bold">$95.00</span>
                        </div>
                        <div class="mt-4 flex items-center">
                            <div class="flex text-yellow-400">
                                <i class="fas fa-star"></i>
    ...
    <section class="py-16 bg-amber-50">
        <div class="max-w-3xl mx-auto px-4 text-center">
            ...
            <form class="flex flex-col sm:flex-row gap-2">
                <input type="email" placeholder="Your email address" class="px-4 py-3 rounded-lg flex-grow border border-gray-300 focus:outline-none focus:ring-2 focus:ring-amber-500">
                <button type="submit" class="px-6 py-3 bg-amber-600 text-white rounded-lg hover:bg-amber-700 transition duration-300">Subscribe</button>
            </form>
        </div>
    </section>
</main>
